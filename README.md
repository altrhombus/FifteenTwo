...
Phases 1–10 of [`docs/plan.md`](docs/plan.md)'s build order are complete: solo play against an exact-solver CPU (with training breakdown and replay), physical board companion mode with SwiftData history, a watchOS companion for the board, adaptive iPad/Mac layouts, and Game Center achievements/leaderboards. Multipeer pass-and-play (Phase 11) is next.
