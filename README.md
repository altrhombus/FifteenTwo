...
Phases 1–12 of [`docs/plan.md`](docs/plan.md)'s build order are complete: solo play against an exact-solver CPU (with training breakdown and replay), physical board companion mode with SwiftData history, a watchOS companion for the board, adaptive iPad/Mac layouts, Game Center achievements/leaderboards, and Multipeer + SharePlay pass-and-play. Vision hand-scanning (Phase 13) is next.
